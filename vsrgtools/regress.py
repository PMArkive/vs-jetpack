...
class SubsampledShift(vs_object):
    """
...
class ChromaReconstruct(ABC, vs_object):
    ...
    def regression(
        ...
        **kwargs: Any,
        ...
        if errors:
            raise ExceptionGroup("Demangled luma and chroma planes must have the same resolution and format.", errors)  # noqa: F821
    ...
    def __vs_del__(self, core_id: int) -> None:
        for name in ["luma_base", "chroma_bases", "clip_src", "_demangled_luma", "_demangled_chroma", "_rchroma"]:
