...
class _Plugin_vszip_Core_Bound(Plugin):
    ...
    def Limiter(self, clip: VideoNode, min: _SingleAndSequence[float] | None = None, max: _SingleAndSequence[float] | None = None, tv_range: int | None = None, planes: _SingleAndSequence[int] | None = None) -> ConstantFormatVideoNode: ...
    def Metrics(self, reference: VideoNode, distorted: VideoNode, mode: int | None = None) -> ConstantFormatVideoNode: ...
...
class _Plugin_vszip_VideoNode_Bound(Plugin):
    ...
    def Limiter(self, min: _SingleAndSequence[float] | None = None, max: _SingleAndSequence[float] | None = None, tv_range: int | None = None, planes: _SingleAndSequence[int] | None = None) -> ConstantFormatVideoNode: ...
